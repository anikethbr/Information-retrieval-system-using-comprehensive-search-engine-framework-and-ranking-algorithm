...
def user_reply():
    if request.method == "POST":
        ...
        try:
            ...
            # pass
            with open("text_files/aSummary.txt", "w", errors="ignore", encoding="utf-8") as f:
        ...
        try:
            ...
            f = open("text_files/news.txt", "a", errors="ignore", encoding="utf-8")
            # f.write(str(data))
            ...
            with open("text_files/newsNoDup.txt", "a", encoding="utf-8") as f:
            ...
            # pass
            with open("text_files/rankedNews.txt", "w", encoding="utf-8") as f:
...
def getNews(cat):
    ...
    f = open("text_files/newsApi.txt", "w")
    f.close()
